            ...
            <div class="col-md-10 main-content p-4">
				...
				<div class="card mb-4">
					<div class="card-body">
						<div class="row g-3">
							<div class="col-md-2">
								<label class="form-label">기간</label> <select class="form-select" id="periodFilter">
							...
							<div class="col-md-2">
								<label class="form-label">상태</label> <select class="form-select" id="statusFilter">
									<option value="">전체</option>
							...
							<div class="col-md-2">
								<label class="form-label">위험도</label> <select class="form-select" id="riskFilter">
									<option value="">전체</option>
							...
							<div class="col-md-2">
								<label class="form-label">구/동</label> <select class="form-select" id="guFilter">
									<option value="">전체</option>
							...
							<div class="col-md-2">
								<label class="form-label">정렬</label> <select class="form-select" id="sortFilter">
						...
						<div class="row mt-3">
							<div class="col-md-8">
								<div class="input-group">
									...
									</select> <input type="text" class="form-control" id="searchKeyword" placeholder="검색어를 입력하세요" onkeypress="handleEnterKey(event)">
