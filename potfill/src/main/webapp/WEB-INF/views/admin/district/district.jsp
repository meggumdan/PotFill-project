	...
	<div class="admin-layout">
		...
		<main class="admin-main">
			<div class="top-row">
				...
				<!-- 최근 7일 건수 -->
				<div class="card-vertical" style="max-height: 240px; min-width: 700px; padding:20 40 40 20;">
					<p style="text-align: center; padding-bottom: 5px;">최근 7일간 발생
						및 처리 건수</p>
					<canvas id="barChart" width="500px" height="160px"></canvas>
				</div>
